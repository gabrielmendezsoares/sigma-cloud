...
import { appService, createServiceOrderX1Service } from "../services/index.js";
    ...
    generateRoute(
      {
        method: 'post',
        version: 'v1',
        url: 'create/service-order-x1',
        serviceHandler: createServiceOrderX1Service.createServiceOrderX1,
        requiresAuthorization: true
      } as IRouteMap.IRouteMap
    );
